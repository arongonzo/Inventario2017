...
public class FrmSistema extends javax.swing.JInternalFrame {

    SistemaLog sistemas;
    Sistema sis;
    ModeloTablaSistema mts;
    
    public FrmSistema() {
        initComponents();
        sistemas = new SistemaLog();
        ListarTabla();
        Limpiar();
    ...
    private void llenarexcel()
    {
            ...
            try
            {
                FileOutputStream fos= new FileOutputStream(new File("c:/excel/excelsistema.xlsx"));
                wb.write(fos);
                fos.close();
    ...
    private void ListarTabla() {
        ...
        List<Sistema> listas = sistemas.listado(Filtro);
        mts = new ModeloTablaSistema(listas);
    ...
    private void initComponents() {
        ...
        lblsistema.setText("Nombre Sistema");
    ...
    private void btn_grabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_grabarActionPerformed
        ...
        if(validar_formulario()){
            ...
            if(id_sistema ==0){
                sis = new Sistema(id_sistema, txt_sistema.getText(), txt_descripcion.getText());
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        sis = ((ModeloTablaSistema) jTable1.getModel()).DameSistema(jTable1.getSelectedRow());

        lblLlavesistema.setText(String.valueOf(sis.getIdsistema()));
        txt_sistema.setText(sis.getNombre_Sistema());
        txt_descripcion.setText(sis.getDescripcion_Sistema());
